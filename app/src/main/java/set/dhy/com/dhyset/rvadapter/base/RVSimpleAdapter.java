...
import set.dhy.com.dhyset.rvadapter.cell.EmptyCell;
import set.dhy.com.dhyset.rvadapter.cell.ErrorCell;
import set.dhy.com.dhyset.rvadapter.cell.LoadMoreCell;
import set.dhy.com.dhyset.rvadapter.cell.LoadingCell;
...
public class RVSimpleAdapter extends RVBaseAdapter {
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    return (viewType == OftenViewType.ERROR_TYPE || viewType == OftenViewType.EMPTY_TYPE || viewType == OftenViewType.LOADING_TYPE
                            || viewType == OftenViewType.LOAD_MORE_TYPE) ? gridLayoutManager.getSpanCount() : 1;
                }
            });
        }
    }
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (isStaggeredGridLayout(holder)) {
            if (viewType == OftenViewType.ERROR_TYPE || viewType == OftenViewType.EMPTY_TYPE || viewType == OftenViewType.LOADING_TYPE
                    || viewType == OftenViewType.LOAD_MORE_TYPE) {
    ...
    public void showLoadMore(View loadMoreView, int height) {
        ...
        //设置默认高度
        if (height == 0) {
            int defaultHeight = DpAndPx.dpToPx(loadMoreView.getContext(), LoadMoreCell.mDefaultHeight);
