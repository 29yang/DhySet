...
//        }
    ...
    public boolean onScale(ScaleGestureDetector detector) {
        ...
        if ((scale < mMaxScale && mIntentScale > 1.0f) || (scale > mInitScale && mIntentScale < 1.0f)) {

            // scale 变小时， intentScale变小
            if (scale * mIntentScale < mInitScale) {
                // intentScale * scale = mInitScale ;
                mIntentScale = mInitScale / scale;
            }
